    ...
    return (
        <div className="bg-white min-h-screen relative">
            ...
            <div className="relative w-full">
                ...
                <div
                    className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4 mt-10">
                    <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold">Read {searchParams.get("name")}'s
                        Essays</h1>
