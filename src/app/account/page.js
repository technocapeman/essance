            ...
            <div className="min-h-screen flex flex-col items-center">
                <div className="w-full max-w-6xl px-8 py-16">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <h1 className="text-2xl text-black font-bold">Hey Kapilesh.</h1>
                    </div>
                    <div className="w-full">
                        <div className="flex items-center mb-4">
                            <label className="w-1/4 text-gray-700 font-medium">Full Name:</label>
                            <div className="w-3/4 px-4 py-2 border rounded-lg bg-gray-100 text-black">Kapilesh
                                Pennichetty
                            </div>
                        </div>
                        <div className="flex items-center mb-4">
                            ...
                            <div
                                className="w-3/4 px-4 py-2 border rounded-lg bg-gray-100 text-black">essanceaiapp@gmail.com
                            </div>
                        </div>
                        <div className="flex items-center mb-4">
